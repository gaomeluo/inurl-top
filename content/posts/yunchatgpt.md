...
description: |-
  ...
  那么用自己的服务器搭建chatgpt，就解决了频繁更换IP的烦恼，如果使用自己的域名还方便记。本文教你如何快速搭建基于OpenAI的ChatGPT。
categories:
  - yuanquan
tags:
  - 如何搭梯子？
...
传送门：<https://inurl.link/aliyunqingliang>
...
通过作者的推荐网址进行购买，<https://inurl.link/api2d> , 作者可以获得奖励（写教程不易，希望大家可以通过这个链接购买，作者可以获得100p的奖励，用于今后继续创作）
